...
// Create router ONCE at module level (outside any component)
// This prevents the router from being recreated on every render,
// which can cause white screen issues on mobile browser refresh
...
// Simple wrapper component - router is stable, created once at module load
