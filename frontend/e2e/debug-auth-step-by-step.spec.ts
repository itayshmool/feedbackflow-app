// frontend/e2e/debug-auth-step-by-step.spec.ts

import { test, expect } from '@playwright/test';

test.describe('Debug Auth Step by Step', () => {
  test('Step by step authentication check', async ({ page }) => {
    ...
    // Take a screenshot
    await page.screenshot({ path: 'debug-auth-step-by-step.png' });
